...
ブラウザ自動化のツールなら、`comken/toolbox/browser/sites/ntt/pages/` にある
Page Object Model 構成を合わせて使う（NTT西・NTT東 を束ねる例外形。姉妹サイト
を持たない単独サイト用の 1 サイト＝1 フォルダ形は `docs/機能/browser.md` を参照）。