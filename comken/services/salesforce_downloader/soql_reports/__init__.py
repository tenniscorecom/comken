"""comken/services/salesforce_downloader/soql_reports/__init__.py — SOQLレポートの公開面。
...
from comken.services.salesforce_downloader.soql_reports._registry import registered_reports
