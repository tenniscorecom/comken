"""comken/toolbox/browser/sites/ams_site/pages/login_page.py — ログイン画面（AMS の雛形）
...
from comken.toolbox.browser.sites.ams_site.pages.app_page import AppPage

if TYPE_CHECKING:
    # IDE の補完・型チェック用。ランタイムでは import されない
    from comken.toolbox.browser.sites.ams_site.pages.secure_page import SecurePage
